            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input style="font-size: 20px; font-weight:bold" name="dac_biet" type="radio" value="dac_biet" />Đặc biệt
                                          <input name="dac_biet" type="radio" value="thuong" />Thường <br>
                        </td>
                    </tr>
