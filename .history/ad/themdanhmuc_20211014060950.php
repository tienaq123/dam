...
<body>
    ...
    <div id="wapper">
        ...
        <main>
            <h2 style="font-size: 25px; padding-top: 30px; margin-left: 70px;">Thêm loại hàng</h2>
            <form action="" method="POST">
                <table>
                    ...
                    <tr>
                        <td>
                        <input style="margin: 20px 0px 20px 100px;  width: 1000px; height: 35px;" type="text" name="tendanhmuc"> <br>
