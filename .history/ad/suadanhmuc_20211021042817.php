  ...
  <div id="wapper">
    ...
    <main>
      ...
      <form action="" method="POST">
        ...
        <input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000; cursor:pointer;" type="submit" value="Sửa Lọa hàng" name="btn">
