    ...
    <div id="wapper">
        ...
        <main>
            ...
            <form action="" method="POST">
                ...
                <button style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;border: 1px solid #000;"><input style="border: none; background-color: #ccc;" type="submit" value="Thêm loại hàng" name="btn"></button>
                <button style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;border: 1px solid #000;"><input style="border: none; background-color: #ccc;" type="reset" value="Nhập lại" name="btn"></button>
                
                <input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000;" 
