            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input name="dac_biet" type="radio" value="dac_biet" /><span style="font-size: 17px; font-weight:bold; padding-right: 70px"> Đặc biệt</span>
                                          <input name="dac_biet" type="radio" value="thuong" /><span style="font-size: 17px; font-weight:bold; margin-right: 30px"> Thường</span> <br>
                        </td>
                    </tr>
