            ...
            <form action="" method="POST">
                <table class="main">
                    <tr>
                        ...
                        <td>
                            <input style="margin: 20px 0px 20px 10px;  width: 600px; height: 35px; font-weight:bold;" type="text-box" name="tendanhmuc" value="Auto"> <br>
                        </td>
                    </tr>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input style="margin: 20px 0px 20px 10px;  width: 1000px; height: 35px;" type="text" name="tendanhmuc"> <br>
                        </td>
                    </tr>

                    <tr>
                        <td><input style="background-color: #ccc; width: 160px; height: 30px; margin:0px 0px 20px 90px;" type="submit" value="Thêm loại hàng" name="btn"></td>
                    </tr>
                </table>
