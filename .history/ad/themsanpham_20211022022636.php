            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input type="text" name="ma_hh" disabled> <br></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="right"><input name="dac_biet" type="radio" value="dac_biet" /><span style="font-size: 17px; font-weight:bold; margin-bottom: 30px"> Đặc biệt</span>
                                          <input name="dac_biet" type="radio" value="thuong" /><span style="font-size: 17px; font-weight:bold; margin-bottom: 30px"> Thường</span> <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="right"><input type="date" name="so_luot_xem"> <br></td>
                    </tr>
