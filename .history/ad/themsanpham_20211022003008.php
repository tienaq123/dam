...
<body>
    <div id="wapper">
        ...
        <header id="header">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="./ad/quantrisanpham.php" style="color: red; font-size: 19px;">Hàng hóa</a></li>
        ...
        <main>
            <h2 style="text-align: center; margin: 20px 0px 40px 0px;">THÊM SẢN PHẨM</h2>
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        <td class="left">Vắn tắt sản phẩm</td>
                        <td class="right"><input type="text" name="vantatsp"> <br></td>
                    </tr>

                    <tr>
                        <td class="left">Chi tiết sản phẩm</td>
                        <td class="right"><input type="text" name="chitietsp"> <br></td>
                    </tr>

                    <tr>
                        <td></td>
                        <td class="right"><input type="submit" value="Thêm sản phẩm" name="btn"></td>
                    </tr>
                </table>
