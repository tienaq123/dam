        ...
        <header id="header">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="quantridanhmuc.php" style="color: red; font-size: 19px;">Quản lí loại hàng</a></li>
                    <li><a href="quantrisanpham.php">Quản lí hàng hóa</a></li>
                    <li><a href="quantritaikhoan.php">Quản lí khách hàng</a></li>
                    <div id="nav">
