            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input style="float: left;" name="dac_biet" type="radio" value="dac_biet" /><span style="font-size: 17px; font-weight:bold; float:left;"> Đặc biệt</span>
                                          <input style="float: left;" name="dac_biet" type="radio" value="thuong" /><span style="font-size: 17px; font-weight:bold; float:left;"> Thường</span> <br>
                        </td>
                    </tr>
