...
<body>
    ...
    <div id="wapper">
        ...
        <main>
            <h2 style="font-size: 25px; padding-top: 30px; margin-left: 70px; margin-bottom: 200px;">Thêm loại hàng</h2>
            <form action="" method="POST">
                ...
                <input style="background-color: #ccc; width: 160px; height: 30px; margin:0px 0px 20px 90px;" type="submit" value="Thêm loại hàng" name="btn">
                        </td>
                    </tr>
                </table>
