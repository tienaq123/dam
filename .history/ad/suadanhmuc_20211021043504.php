  ...
  <div id="wapper">
    ...
    <main>
      ...
      <form action="" method="POST">
        <table class="main">
        <input type="hidden" name="madm" value="<?php echo $kqsp['id_danhmuc'] ?>">
          <tr>
            <td>
        ...
        <input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000; cursor:pointer;" type="submit" value="Sửa Loại hàng" name="btn">
      ...
      if (isset($_POST['btn'])) {
        ...
        $sql = "update danhmuc set tendanhmuc='$tendanhmuc' where id_danhmuc='$madm'";
        $kq = $conn->exec($sql);
        if ($kq == 1)
