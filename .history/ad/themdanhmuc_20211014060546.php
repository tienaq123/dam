...
<body>
    ...
    <div id="wapper">
        ...
        <main>
            <h2 style="font-size: 25px; padding-top: 30px; margin-left: 70px;">Thêm danh mục</h2>
            <form action="" method="POST">
                <table>
                    <tr>
                        <td>
                            <Span style="font-size: 23px; font-weight:bold;">Tên danh mục: </Span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <input style="margin: 20px 0px 20px 90px; " type="text" name="tendanhmuc"> <br>
                <input style="background-color: #ccc; width: 500px; height: 60px; margin:0px 0px 20px 80px;" type="submit" value="Thêm danh mục" name="btn">
                        </td>
                    </tr>
                </table>
