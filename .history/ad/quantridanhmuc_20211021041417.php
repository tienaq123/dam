            ...
            <table border="4" style="text-align: center;">
                ...
                ?>
                    <tr>
                        ...
                        <td class="suaxoa"><a href="suasanpham.php?masua=<?php echo $rows['id_sp'] ?>">Sửa</a></td>
                        <td class="suaxoa"><a onclick="return confirm('Bạn có muốn xóa không!')" href="xoasanpham.php?maxoa=<?php echo $rows['id_sp'] ?>">Xóa</a></td>
                    </tr>
                <?php }
                ?>
            </table>
