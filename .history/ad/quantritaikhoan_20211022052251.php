...
<body>
    <div id="wapper">
        ...
        <header id="header">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="quantritaikhoan.php" style="color: red; font-size: 19px;">Tài khoản</a></li>
        ...
        <main>
            ...
            <button style="background-color: #fff; width: 160px; height: 30px; margin:40px 0px 20px 20px; border: 1px solid #000; cursor:pointer;"><a href="../dangky.php">Thêm mới</a></button>
