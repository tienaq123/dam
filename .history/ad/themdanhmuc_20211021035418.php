            ...
            <form action="" method="POST">
                <table class="main">
                    <tr>
                        ...
                        <td>
                            <input style="margin: 20px 0px 20px 10px;  width: 600px; height: 35px; font-weight:bold; background-color: #ccc; border: 1px solid #000;" type="text" name="tendanhmuc" value="          Auto numble" readonly> <br>
                        </td>
                    </tr>
                    </tr>
                    <tr>
                ...
                <button><input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000;" type="submit" value="Thêm loại hàng" name="btn"></button>
                <button><input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000;" type="reset" value="Nhập lại" name="btn"></button>
