            ...
            <form action="" method="POST">
                <table class="main">
                    <tr>
                        ...
                        <td>
                            <input style="margin: 20px 0px 20px 10px;  width: 600px; height: 35px; font-weight:bold; background-color: #ccc; border: 1px solid #000;" type="text" name="tendanhmuc" value="          Auto numble" disabled> <br>
                        </td>
                    </tr>
                    </tr>
                    <tr>
