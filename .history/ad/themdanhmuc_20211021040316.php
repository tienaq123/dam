    ...
    <div id="wapper">
        ...
        <main>
            ...
            <form action="" method="POST">
                ...
                <input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000; cursor:pointer;" type="submit" value="Thêm loại hàng" name="btn">
                <input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px; border: 1px solid #000; cursor:pointer;" type="reset" value="Nhập lại" name="btn">
                ...
                <a href="quantridanhmuc.php"><button style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;border: 1px solid #000;">Danh Sách Danh mục</button></a>
