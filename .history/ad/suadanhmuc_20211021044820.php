      ...
      <form action="" method="POST">
        ...
        <input type="hidden" name="madm" value="<?php echo $kqsp['id_danhmuc'] ?>">
          <tr>
            ...
            <td>
              <input style="margin: 20px 0px 20px 10px;  width: 600px; height: 35px; font-weight:bold; font-size: 18px; background-color: #ccc; border: 1px solid #000;" type="text" name="ma" value="          Auto numble" disabled> <br>
            </td>
          </tr>
