            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input name="dac_biet" type="radio" value="dac_biet" /><span style="font-size: 20px; font-weight:bold"> Đặc biệt</span>
                                          <input name="dac_biet" type="radio" value="thuong" /><span style="font-size: 20px; font-weight:bold"> Thường</span> <br>
                        </td>
                    </tr>
