        ...
        <main>
            ...
            <form action="" method="POST">
                <table class="main">
                    ...
                    <tr>
                        <td><input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;" type="submit" value="Thêm loại hàng" name="btn"></td>
                        <td><input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;" type="reset" value="Nhập lại" name="btn"></td>
                        <td><input style="background-color: #ccc; width: 160px; height: 30px; margin:40px 0px 20px 90px;" type="link" value="Nhập lại" name="btn"></td>
                    </tr>
                </table>
