    ...
    <div id="wapper">
        ...
        <main>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right"><input type="text" name="ten_hh"> <br></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="right"><input style="height: 200px;" type="text" name="mo_ta"> <br></td>
                    </tr>
            ...
            if (isset($_POST['btn'])) {
                ...
                $sql = "insert into hang_hoa values(null, '$tenhh', '$dongia', '$giamgia', '$tenanh', '$ngaynhap', '$mota', '$dacbiet', '$soluotxem', '$danhmuc')";
                $kq = $conn->prepare($sql);
                if ($kq->execute()) {
