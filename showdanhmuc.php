...
<head>
    ...
    <link rel="stylesheet" href="./css/showdanhmuc.css">
</head>
...
<body>
    <div id="wapper">
        ...
        <div id="title_product">
            <h1>PRODUCT</h1>
            <span><a href="home.php">Trang chủ </a>> Product</span>
        </div>
    ...
    if(isset($_GET['madanhmuc'])){
        ...
        $sqldanhmuc="select * from sanpham where id_danhmuc='$madanhmuc'";
    ...
    <!--  -->
        <h1 id="h1_content">
        <?php include 'db.php';
            $sql = "select * from danhmuc where id_danhmuc='$madanhmuc'";
            $kq = $conn->query($sql);
         foreach ($kq as $key => $rows) {
            ?>
        <h1 style="text-align: center; font-size: 40px"><?php echo $rows['tendanhmuc']; ?></h1>
    ...
    <!--  -->
        ...
        <section id="content">
        <?php include 'db.php';
            $sql = "select * from sanpham where id_danhmuc='$madanhmuc'";
            $kq = $conn->query($sql);
            foreach ($kq as $key => $rows) {
            ?>
